...
public class AddContactActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        txtAddFriend.setText(R.string.search);
    }
    ...
    public void addContact(View view) {
        if (EMClient.getInstance().getCurrentUser().equals(meditUsername.getText().toString())) {
            new EaseAlertDialog(this, R.string.not_add_myself).show();
            return;
        }
        if (SuperWeChatHelper.getInstance().getContactList().containsKey(meditUsername.getText().toString())) {
            //let the user know the contact already in your contact list
            if (EMClient.getInstance().contactManager().getBlackListUsernames().contains(meditUsername.getText().toString())) {
    ...
    @OnClick({R.id.ivBack, R.id.txt_add_friend})

...
public class RegisterActivity extends BaseActivity {
    ...
    @Bind(R.id.register_edUserName)
    EditText mregisterEdUserName;
    @Bind(R.id.register_edNick)
    ...
    @Bind(R.id.register_btnRegister)
    ...
    public void register() {
        nickname = mregisterEdNick.getText().toString().trim();
        username = mregisterEdUserName.getText().toString().trim();
        pwd = mregisterEdPassword.getText().toString().trim();
        String confirm_pwd = medConfirmPassword.getText().toString().trim();
        if (TextUtils.isEmpty(username)) {
            Toast.makeText(this, getResources().getString(R.string.User_name_cannot_be_empty), Toast.LENGTH_SHORT).show();
            mregisterEdUserName.requestFocus();
            return;
            ...
            mregisterEdNick.requestFocus();
            return;
        } else if (TextUtils.isEmpty(pwd)) {
            Toast.makeText(this, getResources().getString(R.string.Password_cannot_be_empty), Toast.LENGTH_SHORT).show();
            mregisterEdPassword.requestFocus();
            return;
    ...
    @OnClick({R.id.layout_back, R.id.register_btnRegister})

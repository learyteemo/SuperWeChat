...
public class LoginActivity extends BaseActivity {
    ...
    private void setListener() {
        ...
        mloginEdUserName.addTextChangedListener(new TextWatcher() {
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                medPassword.setText(null);
            }
    ...
    public void login() {
        ...
        currentUsername = mloginEdUserName.getText().toString().trim();
        currentPassword = medPassword.getText().toString().trim();

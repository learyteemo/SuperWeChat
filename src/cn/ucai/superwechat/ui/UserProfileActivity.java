...
public class UserProfileActivity extends BaseActivity implements OnClickListener {
  ...
  EaseUserUtils.setCurrentAppUserAvatar(this,mivProfileAvatar);
        ...
        EaseUserUtils.setCurrentweixinhapuserName(mtvProfileWeixinhao);
    }
    ...
    private void updateAppnNick(String nickName) {
    ...
    @OnClick({R.id.ivBack,R.id.layout_title, R.id.layout_profile_nick, R.id.layout_weixinhao})
                ...
                new Builder(this).setTitle(R.string.setting_nickname).setIcon(android.R.drawable.ic_dialog_info).setView(editText)
                        .setPositiveButton(R.string.dl_ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                CommonUtils.showMsgShortToast(R.string.toast_nick_not_modify);
                                    return;
                                }

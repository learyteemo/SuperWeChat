...
//        GridLayoutManager glm = (GridLayoutManager) recyclerView.getLayoutManager();
    ...
    private class ChatRoomAdapter extends ArrayAdapter<EMChatRoom> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.layout_livelist_item, parent, false);
            }
    ...
    static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        public PhotoViewHolder(View itemView) {
            ...
            anchor = (TextView) itemView.findViewById(R.id.author);
            audienceNum = (TextView) itemView.findViewById(R.id.audience_num);
        }
    }

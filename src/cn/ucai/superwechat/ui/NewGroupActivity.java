...
public class NewGroupActivity extends BaseActivity {
    ...
    mivBack.setVisibility(View.VISIBLE);
        ...
        mtxtAddFriend.setText(getString(R.string.button_save));
    }
        ...
        public void onSuccess(String s) {
            if (s != null) {
                ...
                if (result != null && result.isRetMsg()) {
                    ...
                    progressDialog.dismiss();
                    CommonUtils.showMsgShortToast(R.string.Failed_to_create_groups);
                }
            } else {
                progressDialog.dismiss();
                CommonUtils.showMsgShortToast(R.string.Failed_to_create_groups);
    ...
    private void addGroupMembers() {
        NetDao.addGrouopMembers(this, emgroup, new OkHttpUtils.OnCompleteListener<String>() {
            @Override
            public void onSuccess(String s) {
                if (s!=null) {
                Result result = ResultUtils.getResultFromJson(s,Group.class);
  ...
  /*  public void back(View view) {
    ...
    @OnClick({R.id.ivBack, R.id.txt_add_friend, R.id.layout_group_icon, R.id.cb_public, R.id.cb_member_inviter})
